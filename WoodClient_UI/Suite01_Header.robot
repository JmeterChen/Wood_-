...
new built
    New Built
    Page Should Contain Element    ${test_tabs_num}    2
...
# 这里还需要补充积木模式下作品名称hover
    ...
    \    Sleep    0.5
    \    Control Set Text    打开    \    1148    ${py_file_unnormal}
    \    Sleep    0.5
    \    Control Click    打开    \    1
    \    Sleep    0.5
    \    Control Set Text    打开    \    1148    ${test_py_name[${i}]}
...
open_untrans_file
    ...
    Win Exists    打开
    Win Active    打开
    Control Set Text    打开    \    1148    ${file_untrans}
    Control Click    打开    \    1
    Page Should Contain Element    ${wood_error_file}
    Element Text Should Be    ${wood_error_file}    请打开 .py 或 .hex 后缀的文件
    Sleep    0.5
...
save_file
    ...
    Control Set Text    另存为    \    1001    ${download_file}
    Control Click    \    \    Button2
    Control Set Text    另存为    \    1001    ${file_name}
    Sleep    0.5
    Control Click    \    \    Button2
    Sleep    1
...
save_as
    ...
    Control Set Text    另存为    \    1001    ${download_file}
    Control Click    \    \    Button2
    Control Set Text    另存为    \    1001    ${cur_tab_name}.py
    Sleep    0.5
    Control Click    \    \    Button2
    Sleep    1
...
sample_works
    ...
    ${test_temp_num}    Get Matching Xpath Count    ${wood_template_num}
...
cloud_file_scroll
    ...
    Click Element    ${wood_file_icon}
    Click Element    ${wood_file_open_cloud}
    ${num_list}    Get Matching Xpath Count    ${wood_cloud_file_frame1}
    ...
    # ${num_list_scroll}    Get Matching Xpath Count    ${wood_cloud_file_frame1}
    # Pass Execution If    ${num_list_scroll}>${num_list}    'Scrolling is Successfully!'
    # ...    ELSE    Fail
...
i18n_block_headline_UI
    @{eng_block}    Create List    Events    Control    Operators    Strings    Variables    Lists
    ...    Dictionary    Functions    Turtle Library    Advance    Spider
    @{com_font_block}    Create List    事件    控制    運算    字符串    變量    列表    字典    函數
    ...    海龜庫    高級   爬蟲
    @{china_block}    Create List    事件    控制    运算    字符串    变量    列表    字典    函数
    ...    海龟库    高级    爬虫
    ...
    Page Should Contain Element    ${wood_toolbox_list}    limit=11
...
library_search
    ...
    Sleep    1
    Page Should Contain Element    ${wood_library_xpath}    limit=1
    ...
    Wait Until Element Contains    ${wood_third_search_result}    ty
    ...
    Wait Until Element Contains    ${wood_lib_install_cancle}    已安装
    Input Text    ${wood_library_third_search}    pygame
    Click Element    ${wood_third_search_icon}
    Wait Until Element Contains    ${wood_third_search_toast}    Pygame已在库列表中，请返回上一页安装！
